...
import { videoShowcaseData } from "@/lib/data/video";
                    ...
                    <div className="flex flex-col lg:flex-row items-center gap-10 md:gap-16">
                        ...
                        <div className="w-full lg:w-3/5">
                            <div className="relative group cursor-pointer" onClick={() => setIsOpen(true)}>
                                ...
                                <div className="relative rounded-2xl md:rounded-[2.5rem] overflow-hidden shadow-2xl h-[220px] md:h-[450px]">
                                    <Image
                                        src={getAssetPath(videoShowcaseData.thumbnail.image)}
                                        alt={videoShowcaseData.thumbnail.alt}
                                        fill
                                    ...
                                    <div className="absolute bottom-0 left-0 right-0 p-4 md:p-8 bg-gradient-to-t from-black/80 to-transparent">
                                        <div className="flex items-center gap-3 md:gap-4 text-white">
                                            ...
                                            <div>
                                                <p className="text-[10px] font-black tracking-widest uppercase opacity-70">{videoShowcaseData.callToAction}</p>
                                                <h3 className="text-sm md:text-xl font-black uppercase tracking-tight">{videoShowcaseData.videoTitle}</h3>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div className="w-full lg:w-2/5">
                            ...
                            <ul className="space-y-4 md:space-y-6 mb-8 md:mb-10">
                                {videoShowcaseData.keyPoints.map((item, i) => (
                ...
                <div className="fixed inset-0 z-[100] bg-black/95 backdrop-blur-xl flex items-center justify-center p-4">
                    ...
                    <div className="w-full max-w-5xl aspect-video bg-white/10 rounded-2xl md:rounded-[2.5rem] flex flex-col items-center justify-center text-white border-2 border-white/20 overflow-hidden relative">
                        <div className="text-center p-8 md:p-12">
                            ...
                            <h3 className="text-xl md:text-3xl font-black mb-2 md:mb-4 uppercase tracking-tight">{videoShowcaseData.modal.title}</h3>
                            <p className="text-white/60 text-sm md:text-xl max-w-md mx-auto font-medium">
                                {videoShowcaseData.modal.description}
                            </p>
                            <button
                                onClick={() => setIsOpen(false)}
                            ...
                            >
                                {videoShowcaseData.modal.closeButton}
                            </button>
                        </div>
