                ...
                <div className="max-w-6xl mx-auto">
                    <div className="flex flex-col lg:flex-row items-center gap-16">
                        ...
                        <div className="relative w-full max-w-[500px] aspect-square flex items-center justify-center">
                            ...
                            {steps.map((step) => {
                                ...
                                return (
                                    <button
                                        ...
                                        style={{
                                            transform: `rotate(${step.angle - 90}deg) translate(180px) rotate(${-(step.angle - 90)}deg)`,
                                            left: 'calc(50% - 32px)',
                                            top: 'calc(50% - 32px)'
                                        }}
                                    >
                                        <div className={`w-16 h-16 md:w-20 md:h-20 rounded-2xl flex items-center justify-center text-3xl md:text-4xl transition-all duration-500 shadow-lg ${isActive || isHovered
                                            ...
                                            {/* Label on desktop */}
                                            <span className={`absolute -bottom-8 whitespace-nowrap text-[10px] font-bold tracking-widest uppercase transition-opacity duration-300 ${isActive || isHovered ? 'text-primary-800 opacity-100' : 'text-gray-400 opacity-0 group-hover:opacity-100'
                                                }`}>
                                                {step.name}
                                            </span>
                                        </div>
                            ...
                            {/* Central Core */}
                            <div className="relative w-48 h-48 md:w-56 md:h-56 rounded-full bg-white shadow-2xl flex flex-col items-center justify-center text-center p-6 border-8 border-primary-50">
                                <div className="absolute inset-0 rounded-full bg-primary-500/5 animate-ping"></div>
                                <h4 className="text-primary-800 font-black text-lg md:text-xl leading-tight">
                                    SIRKULAR<br />EKONOMI
                                </h4>
                                <div className="w-12 h-1 bg-primary-200 my-3 rounded-full"></div>
                                <p className="text-[10px] text-primary-600 font-bold tracking-widest">GREENETIX BOY</p>
                            </div>
                        </div>
